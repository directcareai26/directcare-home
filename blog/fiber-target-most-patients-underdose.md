...
Source: https://www.directcare.ai/blog/fiber-target-most-patients-underdose
...
Save up to 80% on prescriptions with the DirectCare Pharmacy Card. [Get yours free →](https://therxcard.net/ZW6727/en/home)
 ...
 January 25, 2026
 Clinically reviewed by [Dr. Tim Pepin, D.C.](https://www.directcare.ai/#dr-tim-pepin) on 2026-01-25

## Fiber: the nutrient most weight-loss patients underdose (and the fix)

 The published target is 25 to 35 grams per day. The American average is under 15. On a GLP-1 or HRT protocol, that gap drives constipation, satiety failure, and inflammation. Here's how to actually close it.
...
### The target, in real numbers.
 ...
 The [Dietary Guidelines for Americans](https://www.dietaryguidelines.gov/) and the [Harvard T.H. Chan School of Public Health](https://nutritionsource.hsph.harvard.edu/carbohydrates/fiber/) both anchor on **14 grams of fiber per 1,000 calories consumed.** For a 2,000-calorie day, that's 28 g. For a 1,500-calorie day (typical on a GLP-1), it's 21 g.
...
- Fiber feeds short-chain-fatty-acid production. SCFAs (butyrate, propionate, acetate) from fermented fiber in the colon are anti-inflammatory and support insulin sensitivity. This is one of the better-documented mechanisms by which fiber helps metabolic health. See the [American Heart Association's fiber overview](https://www.heart.org/en/healthy-living/healthy-eating/eat-smart/nutrition-basics/whole-grains-refined-grains-and-dietary-fiber).

 The two fibers

 Soluble fiber (oats, beans, psyllium, chia) slows glucose absorption and feeds gut bacteria. Insoluble fiber (vegetables, whole grains, nuts) supports transit. You want both. A useful default is roughly half and half.
...
#### 1. Beans and lentils
 ...
 The highest-density fiber source in the kitchen. A half-cup of black beans, lentils, or chickpeas delivers **7 to 8 grams**, with 7+ grams of protein on the side.
...
### Supplements: when and which.
 ...
 We don't recommend metamucil-style sugary fiber drinks. Plain psyllium powder is cheaper and cleaner. The [NIH Office of Dietary Supplements](https://ods.od.nih.gov/factsheets/list-all/) has a useful overview if you want to dig in.

### Ramp the dose.

 Going from 12 g to 30 g of fiber overnight produces predictable consequences. Gas, bloating, and the kind of GI day you don't want. Add 5 g per day, every 3 to 4 days, until you're at target. Hydration tracks with it.
 ...
 Sources: [Dietary Guidelines for Americans](https://www.dietaryguidelines.gov/); [Harvard T.H. Chan School of Public Health](https://nutritionsource.hsph.harvard.edu/carbohydrates/fiber/); [American Heart Association on whole grains and fiber](https://www.heart.org/en/healthy-living/healthy-eating/eat-smart/nutrition-basics/whole-grains-refined-grains-and-dietary-fiber); [NIH Office of Dietary Supplements](https://ods.od.nih.gov/factsheets/list-all/).
