# HRT After 40: What Actually Changes
...
## HRT after 40: what actually changes when estradiol and progesterone come back online
 ...
 The bloodwork shifts, the symptoms shift, and so does your protocol. A clinician's plain-English breakdown of what to expect. Month by month. When you start hormone replacement therapy in your 40s.
...
### What a thorough HRT workup can look like.

 Symptoms tell you something is happening. Bloodwork tells you what is happening. And for the women who want the most precise protocol, labs are how a clinician dials in the dose, the route, and the timing.

 DirectCare AI offers a clinician-ordered hormone panel as part of our Blood Labs product. For women who choose to run it, the markers worth looking at include:

- Estradiol (E2)

- Progesterone

- FSH and LH (the pituitary signals. These are how a clinician confirms perimenopause vs. early menopause vs. something else entirely)
...
- Lipid panel and a CMP
 ...
 Roughly one in four women who walk in convinced they need HRT have a thyroid issue, an iron deficiency, or both as part of the picture. And they tend to feel dramatically better once those are addressed alongside the hormones. Bloodwork is the cleanest way to catch that.

### Month 1: the noise stops.

 On a typical protocol. Transdermal estradiol patch or gel, plus oral micronized progesterone at night. The first thing most patients notice in week 2 to 3 is what isn't there anymore.
...
### Month 2: the symptoms you'd stopped noticing.
 ...
 Around the 6-week mark is also a good time for a follow-up panel, if you ran one to start. A recheck looks at whether your E2 has reached a healthy mid-range (typically 60 to 120 pg/mL on a transdermal protocol, though this varies), whether progesterone is doing its job, and whether anything else has shifted in an unexpected direction.

### Month 3 to 4: fine-tuning, not transformation.
...
- Testosterone . Many women in their 40s have testosterone in the low single digits when they should be in the 30 to 70 ng/dL range. A small dose of testosterone (typically a compounded cream) often does as much for libido, energy, and mental clarity as the estrogen does.
...
- Week 1 to 2: Sleep improvement, mood floor rises.

- Week 3 to 6: Hot flashes and night sweats meaningfully reduced.

- Month 2 to 3: Libido, joint comfort, cognition, skin tone all shift.

- Month 3 to 4: Bloodwork-driven dose adjustments; protocol stabilizes.
