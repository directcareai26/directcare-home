# Magnesium Glycinate vs. Citrate: Which Form?
...
- Vitamin D (25-OH). Magnesium and vitamin D move together — low D often hides a low-magnesium problem, and supplementing one without the other is a familiar dead end.
 ...
 Supplementing magnesium without a panel is reasonable for short-term symptom support. Supplementing it for months without ever checking RBC magnesium, vitamin D, and parathyroid function is how people end up convinced "magnesium doesn't work for me" when the actual problem is somewhere upstream.
...
#### Build your supplement protocol with a clinician.
 ...
 [See the protocol →](https://www.directcare.ai/supplements)
