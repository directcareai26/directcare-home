...
Source: https://www.directcare.ai/blog/perimenopause-vs-menopause-lab-values
...
Save up to 80% on prescriptions with the DirectCare Pharmacy Card. [Get yours free →](https://therxcard.net/ZW6727/en/home)
 ...
 July 21, 2026
 Clinically reviewed by [Dr. Tim Pepin, D.C.](https://www.directcare.ai/#dr-tim-pepin) on 2026-07-21
...
- Progesterone : frequently low in the luteal phase ( The defining feature is variability, not deficiency. This is why a single FSH draw is diagnostically weak in perimenopause — the Stages of Reproductive Aging Workshop (STRAW+10) criteria explicitly rely on menstrual cycle changes over lab values in this window.
...
- Estradiol : consistently The pattern is stable across repeat draws. That stability is diagnostically useful — a postmenopausal panel doesn't need to be re-run every three months to interpret. It also means treatment targets are clearer: you're replacing what's absent, not chasing what's oscillating.
