# Women's Hair Loss: The Hormonal Panel That Matters
...
## Women's hair loss isn't just male-pattern in pink: the hormonal panel that actually matters
 ...
 Female-pattern hair loss has more drivers than male-pattern: ferritin, thyroid, androgens, and the perimenopausal estradiol drop all play in. The protocol that works starts with the panel that catches them.
 ...
 **5. Stress, illness, and post-partum.** Acute stressors push follicles into telogen effluvium. A synchronous shed that shows up 2 to 3 months after the event. Usually self-resolves within 6 months, but a good clinician identifies it so you don't get put on a chronic protocol you don't need.
...
- Minoxidil 2 to 5% (we titrate up if tolerated)

- Sometimes spironolactone topical 2% for androgen-driven patterns

- Sometimes finasteride 0.05 to 0.1% for postmenopausal women under close monitoring
...
- Occasionally tretinoin 0.01% to improve absorption
 ...
 If your ferritin is below 50, no topical in the world is going to outrun that deficiency. Fix the iron, then fix the scalp.
